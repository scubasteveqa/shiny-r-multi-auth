...
ui <- page_sidebar(
  ...
  layout_columns(
    value_box("SF Total Sales", textOutput("sf_total_sales"), theme = "primary", height = "220px"),
    value_box("SF Orders", textOutput("sf_total_orders"), theme = "info", height = "220px"),
    value_box("SF Avg Order", textOutput("sf_avg_order"), theme = "success", height = "220px"),
    col_widths = c(4, 4, 4)
  ),
  layout_columns(
    card(card_header("Sales by Category"), plotlyOutput("sf_chart_category", height = "550px")),
    card(card_header("Sales by Region"), plotlyOutput("sf_chart_region", height = "550px")),
    col_widths = c(6, 6)
  ),
  ...
  layout_columns(
    value_box("DB Revenue", textOutput("db_total_revenue"), theme = "primary", height = "220px"),
    value_box("DB Orders", textOutput("db_total_orders"), theme = "info", height = "220px"),
    value_box("DB Franchises", textOutput("db_franchise_count"), theme = "warning", height = "220px"),
    col_widths = c(4, 4, 4)
  ),
  layout_columns(
    card(card_header("Revenue by Franchise"), plotlyOutput("db_chart_franchise", height = "550px")),
    card(card_header("Revenue by Continent"), plotlyOutput("db_chart_continent", height = "550px")),
    col_widths = c(6, 6)
  ),

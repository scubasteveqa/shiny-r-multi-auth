...
ui <- page_sidebar(
  ...
  layout_columns(
    card(card_header("Sales by Category"), plotlyOutput("sf_chart_category")),
    card(card_header("Sales by Region"), plotlyOutput("sf_chart_region")),
    col_widths = c(6, 6)
  ),
  ...
  layout_columns(
    card(card_header("Revenue by Franchise"), plotlyOutput("db_chart_franchise")),
    card(card_header("Revenue by Continent"), plotlyOutput("db_chart_continent")),
    col_widths = c(6, 6)
  ),

  # Combined trend
  layout_columns(
    card(card_header("Monthly Trends - Both Sources"), plotlyOutput("combined_trend")),
    col_widths = 12
  )
)
